...
상세 ERD(테이블 관계도)는 `docs/design/STEP3-1_ERD.md`를 참고합니다.
...
| 문서 | 내용 |
| --- | --- |
| `docs/design/STEP1_INGESTION.md` | 수집 구조 |
| `docs/design/STEP2_PROCESSING.md` | Spark 처리 구조 |
| `docs/design/STEP3_STORAGE.md` | 저장 구조 |
| `docs/design/STEP3-1_DATABASE.md` | DB 상세 설계 |
| `docs/design/STEP3-1_ERD.md` | ERD |
| `docs/design/STEP4_ANALYTICS.md` | 이벤트 분석 |
| `docs/design/STEP5_SERVING.md` | API와 대시보드 |
| `docs/design/STEP6_MONITORING.md` | 모니터링과 운영 |
...
| `docs/develop/RSS_INGESTION_PLAN_RESULT.md` | RSS 수집 추가 계획과 결과 |
| `docs/develop/STEP1_DIRECTION_CHANGE_history.md` | 수집 방향 변경 이력 |
