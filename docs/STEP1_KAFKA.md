...
```json
{
  ...
  "description": "Semiconductor companies are seeing record demand for AI processors as companies rush to build generative AI systems.",
  "content": "The surge in AI chip demand comes as major tech companies continue to invest heavily in artificial intelligence infrastructure. NVIDIA, AMD, and other chipmakers are ramping up production to meet demand...",
...
```json
{
  ...
  "description": "South Korea's major technology companies announced multi-billion dollar investments in AI chip development to compete globally.",
  "content": "Samsung Electronics and SK Hynix have announced plans to double their R&D budget for AI semiconductors. The move reflects growing competition in the global chip market...",
